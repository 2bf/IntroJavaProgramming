...
public class MyTriangle {
   ...
   public boolean triOrNo() {
      double slope1 = v1.findSlope(v2);
      double slope2 = v2.findSlope(v3);
      double slope3 = v3.findSlope(v1);
      boolean result = true;
      if (slope1 == slope2 || slope2 == slope3 || slope3 == slope2){
         result = false;
      }
      return result;
   }
   ...
   public String displayType() {
      ...
      String result = "";
      if (slope1 == slope2 || slope2 == slope3 || slope3 == slope2){
         result = "These points do not connect to form a triangle";
         return result;
      }
      double side1 = v1.findDistance(v2);
      double side2 = v2.findDistance(v3);
